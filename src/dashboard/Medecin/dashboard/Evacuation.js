...
import ShowEvacuationBody from './ShowEvacuationBody';

import jsPDF from 'jspdf';
import {Link } from 'react-router-dom'

class Evacuation extends React.Component{
    ...
    generatePdf = () => {
        ...
        var evacuation = this.state.textAreaBody;
        ...
        doc.save('Evacuation.pdf')
        localStorage.setItem('ExamenClinique', JSON.stringify({...informationClinique , evacuation: evacuation.toString()}));
                ...
                <div className='ordonnance_form' style={this.styles.ordonnance_form}>
                    <form className='ordonnance_form_body' id='myForm'>
                        ...
                        <div className='ordonnance_body' style={this.styles.ordonnance_body}>
                            ...
                            <br/>
                            <div>
                            <ShowEvacuationBody text={this.state.textAreaBody} />
                            </div>
                            </div>
