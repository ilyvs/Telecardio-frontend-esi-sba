...
import ShowOrrientationBody from './ShowOrrientationBody';

class Orrientation extends React.Component{
    ...
    generatePdf = () => {
        ...
        var orientation = this.state.textAreaBody;
        console.log("orrientaion tets",orientation)
        ...
        doc.setFont('Helvertica','bold')
        doc.text(170, 180, 'Orrientation')
        doc.setFont('Helvertica','normal')
        doc.text(85, 240, `Je sousigne Dr ${this.state.informationDocteur.nom}  ${this.state.informationDocteur.prenom}`)
        doc.text(85, 270, 'certifie que Mme/Mr : patiente patiente ')
        //console.log('certaficat médical : ',this.state.textAreaBody);
        doc.text(85, 300, ' Né(e) le : dateNaissance à lieu de naissance')
        doc.setFont('Helvertica','normal')
        ...
        doc.save('Orrientation.pdf')
        localStorage.setItem('ExamenClinique', JSON.stringify({...informationClinique , orientation: orientation.toString()}));
                ...
                <div className='ordonnance_form' style={this.styles.ordonnance_form}>
                    <form className='ordonnance_form_body' id='myForm'>
                        ...
                        <div className='ordonnance_body' style={this.styles.ordonnance_body}>
                            ...
                            <div>
                                    Je sousigne <strong>Dr: {this.state.informationDocteur.nom + ' ' + this.state.informationDocteur.prenom}</strong>
                            </div>
                            <div>
                                certifie que Mme/Mr : patiente patiente 
                            </div>
                            <div>
                                Né(e) le : dateNaissance à lieu de naissance
                            </div>
                            <br/>
                            <br/>
                            <div>
                            <ShowOrrientationBody text={this.state.textAreaBody} />
                            </div>
                            </div>
